                                     ...
                                     <div class="modal-dialog">
                                         <div class="modal-content">
                                             ...
                                             <div class="modal-footer">
                                                 ...
                                                 <button type="button" class="btn btn-outline"  onclick="window.location.href='${pageContext.request.contextPath}/editregister/${register.registerId}'" class="btn btn-block btn-info">Delete Yes</button>
                                             </div>
                                         </div>
                                         <!-- /.modal-content -->
                                     </div>
