    ...
    <div class="register-box-body">
        ...
        <form action="editregister/update" method="post">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" value="${registerList.registerName}" placeholder="Full name" name="registerName"id="exampleInputPassword4">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="email" class="form-control" name="registerEmail" value="${registerList.registerEmail}" placeholder="Email" id="exampleInputEmail1">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" class="form-control" name="registerPassword" value="${registerList.registerPassword}"placeholder="Password" id="exampleInputPassword1">
