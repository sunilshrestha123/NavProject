                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="email" class="form-control" id="ename" placeholder="Enter Full Name"  name="ename">
                                    </div>
                                </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="email" class="form-control" id="userid" placeholder="Enter User id"  name="euid">
                                        </div>
                                    </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="phone" placeholder="Enter Full Name"  name="ename">
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>phone</label>
                                                <input type="email" class="form-control" id="mobile" placeholder="Enter Full Name"  name="ename">
                                            </div>
                                            <!-- /.form-group -->
                                            <div class="form-group">
