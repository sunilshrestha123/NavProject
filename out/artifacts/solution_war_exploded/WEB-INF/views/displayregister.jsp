                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                             ...
                             <tr>
                                ...
                                <td>${register.registerPassword}</td>
                             <td><button type="button" onclick="window.location.href='${pageContext.request.contextPath}/editregister/${register.registerId}'" class="btn btn-block btn-info">Edit</button></td>
                                     ...
                                     <div class="modal-dialog">
                                         <div class="modal-content">
                                             ...
                                             <div class="modal-body">
                                                 <p>Are your sure want to Delete these form if yes then click ok else click on cancel</p>
                                             </div>
                                             <div class="modal-footer">
                                                 <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Cancel</button>
                                                 <button type="button" class="btn btn-outline"  onclick="window.location.href='${pageContext.request.contextPath}/deleteregister/${register.registerId}'" class="btn btn-block btn-info">Delete Yes</button>
                                             </div>
                                         </div>
                                         <!-- /.modal-content -->
                                     </div>
...
<!-- jQuery 3 -->
<script src="${pageContext.request.contextPath}/list
...
<!-- DataTables -->
<script src="${pageContext.request.contextPath}/list
/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="${pageContext.request.contextPath}/list
/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="${pageContext.request.contextPath}/list
