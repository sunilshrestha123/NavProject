...
<div class="lockscreen-wrapper">
    <div class="lockscreen-logo">
        <a href="${pageContext.request.contextPath}/list/index2.html"><b>NAV</b>Solution</a>
    </div>
    <!-- User name -->
    ...
    <div class="lockscreen-item">
        ...
        <div class="lockscreen-image">
            <img src="${pageContext.request.contextPath}/list/dist/img/user1-128x128.jpg" alt="User Image">
        </div>
        <!-- /.lockscreen-image -->
    ...
    <div class="text-center">
        <a href="${pageContext.request.contextPath}/login">Or sign in as a different user</a>
    </div>
