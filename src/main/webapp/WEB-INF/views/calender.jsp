...
<%--<head>--%>
    ...
    <%--<!-- fullCalendar -->--%>
    <%--<link rel="stylesheet" href="${pageContext.request.contextPath}/list/bower_components/fullcalendar/dist/fullcalendar.min.css">--%>
    <%--<link rel="stylesheet" href="${pageContext.request.contextPath}/list/bower_components/fullcalendar/dist/fullcalendar.print.min.css" media="print">--%>
    <%--<!-- Theme style -->--%>
...
<%--<!-- fullCalendar -->--%>
<%--<script src="${pageContext.request.contextPath}/list/bower_components/moment/moment.js"></script>--%>
<%--<script src="${pageContext.request.contextPath}/list/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>--%>
