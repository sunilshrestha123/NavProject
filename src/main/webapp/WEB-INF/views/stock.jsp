            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="/savestock">
                            <div class="box-body">
                                <div class="form-group">

                                    <div class="col-xs-4">
                                        <label >Product Name</label>
                                        <input type="text" class="form-control" placeholder="enter product name" name="productName" style='text-transform:uppercase' required>
                                        </div>
                                        <div class="col-xs-4">
                                        ...
                                        <div class="col-xs-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="enter company name" name="productCompanyName" style='text-transform:uppercase' required>
