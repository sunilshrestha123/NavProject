...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/list/plugins/iCheck/flat/blue.css">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-footer">
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                                ...
                                <li>
                                    <span class="mailbox-attachment-icon has-img"><img src="${pageContext.request.contextPath}/list/dist/img/photo1.png" alt="Attachment"></span>
                          ...
                          <a href="#" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                                ...
                                <li>
                                    <span class="mailbox-attachment-icon has-img"><img src="${pageContext.request.contextPath}/list/dist/img/photo2.png" alt="Attachment"></span>
